...
public class CategoryService {
    ...
    public Category save(Category c) {
        ...
        // EVENT: Notify Element Service of Create/Update
        try {
            ...
            // Log error but don't fail the transaction (or do, depending on requirements)
    ...
    public void deleteById(UUID id) {
        // EVENT: Notify Element Service of Delete
        try {
